...
def intro():
    """Introduction story for the game and starting logic"""

    print("""Welcome in this story where you wil follow Ramon and help him in this confusing time.
        ...
        Ramon decides to go back but when he opened the doors he came trough
        it's not changing 
        it looks like he is stuck here.
        Ramon heard some noice he turns around and sees a pendant and picks it up.
        He keeps on walking trough doors till he notices something in the distance.
